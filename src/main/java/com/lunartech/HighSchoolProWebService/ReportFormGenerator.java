...
docPath=new DocPath(schoolDb);
    ...
    public  String reportForms(String examName, String examCode, String academicyear, String classname, String term, String admissionnumber) {
    ...
    String previousExamCode= ExamCodesGenerator.generatecode(previuosClass,String.valueOf( previousYear), previousTerm, "END TERM").toUpperCase();
                ...
                PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"reportForm.pdf"));
                doc.open();
                int counter = 0;
                ...
                ps = con.prepareStatement(sqla,ResultSet.TYPE_SCROLL_SENSITIVE,ResultSet.CONCUR_UPDATABLE);
                rs = ps.executeQuery();
                while (rs.next()) {
                       ...
                       if(!file.exists())
                        ...
                        if(file.exists())
                        {
                          ...
                          BufferedImage outputImage=new BufferedImage(globals.pictureWidth, globals.pictureHeight, inputImage.getType());
                            ...
                            Image   img2 = Image.getInstance(file.getAbsolutePath());
...
//                        final File file=new File(DocPath.documentFolderPath() +""+adm+"chat.jpg");
//                        ChartUtilities.saveChartAsjpg(file, chart, 1000, 200, renderer);
//                         Image img =     img = Image.getInstance(DocPath.documentFolderPath() +""+adm+"chat.jpg");
//                         
                   ...
                   if(!file.exists())
                        ...
                        if(file.exists())
                        {
                          ...
                          BufferedImage outputImage=new BufferedImage(globals.pictureWidth, globals.pictureHeight, inputImage.getType());
                            ...
                            ImageIO.write(outputImage, "jpg", file);
                            Image   img2 = Image.getInstance(configurationIntialiser.imageFolder()+"/" +adm+".jpg");
                            img2.setScaleToFitHeight(true);
                      PdfPCell cell1a = new PdfPCell(img2, true);
                        cell1a.setColspan(5);
                      cell1a.setFixedHeight(60);
