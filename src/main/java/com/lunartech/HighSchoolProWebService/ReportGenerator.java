...
public class ReportGenerator {
   ...
   DocPath docPath;
    ...
    public ReportGenerator(String schoolDb) {
    ...
    public  void onEndPage(PdfWriter writer, Document document) {
       ...
       public  String completionYear(String adm) {
        Connection con;
       ...
       public  void partialMissingMarks(String examcode, String examname, String stream, String term, String academicyear, String subjectcode, String classname, String subjectname,String paper) {
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"missingmarks.pdf"));
            doc.open();
      ...
      public  void partialSubjectResults(String examcode, String examname, String stream, String term, String academicyear, String subjectcode, String classname, String subjectname, String sort,String paper) {
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"subjectResults.pdf"));
            doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
...
//                tabb.addCell(cell6a);
    ...
    public  void feeRegister(String Class,String academicYear,String term ,String votehead)
    {
        ...
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"feeRegister.pdf"));
            doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
...
if(votehead==null)
{
    ...
    vid=globals.voteHeadId(votehead);
       ...
       public  void programClassList(String program,String stream,String classname)
    {
        ...
        try {
            ...
            PdfPTable tab =new PdfPTable(1);
                 ...
                 tab.setWidthPercentage(100);
                 doc.add(tab);  Paragraph pr5=new Paragraph ("PROGRAM CLASS LIST",FontFactory.getFont(FontFactory.HELVETICA,13,java.awt.Font.BOLD,BaseColor.BLACK));
              Chunk glue = new Chunk(new VerticalPositionMark());
            doc.addCreationDate();
             Paragraph pr7=new Paragraph ("CLASS:  "+classname.toUpperCase()+"                 STREAM: "+stream.toUpperCase(),FontFactory.getFont(FontFactory.TIMES,13,java.awt.Font.PLAIN,BaseColor.BLACK));
             pr7.add(new Chunk(glue));
           ...
           doc.add(pr5);
            ...
            sq.printStackTrace(); JOptionPane.showMessageDialog(null, sq.getMessage());
        }
    ...
    public  void feeBalanceReport(String amount,String streamName,String className)
    {
        ...
        try {
            ...
            Document doc=new Document();
            Image image= Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer= PdfWriter.getInstance(doc,new FileOutputStream(  docPath.documentFolderPath() +"feeBalancesReport.pdf"));
            doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab =new PdfPTable(1);
            ...
            tab.setWidthPercentage(100);
            doc.add(tab);  Paragraph pr5=new Paragraph ("Fee Balances".toUpperCase(),FontFactory.getFont(FontFactory.HELVETICA,13,java.awt.Font.BOLD,BaseColor.BLACK));
            Chunk glue = new Chunk(new VerticalPositionMark());
            doc.addCreationDate();
            Paragraph pr7=new Paragraph ("CLASS:  "+className.toUpperCase()+"                 STREAM: "+streamName.toUpperCase(),FontFactory.getFont(FontFactory.TIMES,13,java.awt.Font.PLAIN,BaseColor.BLACK));
            pr7.add(new Chunk(glue));
            Paragraph pr8=new Paragraph ("Amount Filter: "+amount,FontFactory.getFont(FontFactory.TIMES,13,java.awt.Font.PLAIN,BaseColor.BLACK));
            ...
            tabb.setWidthPercentage(100);
            {
                ...
                Phrase ph4=new Phrase("Paid(Ksh)",new Font(Font.FontFamily.HELVETICA, 7, Font.NORMAL,BaseColor.BLACK));
                PdfPCell cell4=new PdfPCell(ph4);
                cell4.setColspan(3);
                cell4.setVerticalAlignment(Element.ALIGN_BOTTOM);
                cell4.setHorizontalAlignment(Element.ALIGN_MIDDLE);

                Phrase ph5=new Phrase("Balance(Ksh)",new Font(Font.FontFamily.HELVETICA, 7, Font.NORMAL,BaseColor.BLACK));
                PdfPCell cell5=new PdfPCell(ph5);
                cell5.setColspan(3);
                ...
                cell6.setRotation(90);
                cell6.setColspan(2);
                tabb.addCell(cell);  tabb.addCell(cell1);  tabb.addCell(cell2);  tabb.addCell(cell3);tabb.addCell(cell4);tabb.addCell(cell5);tabb.addCell(cell6);
            }

            if(className.equalsIgnoreCase("all")&& streamName.equalsIgnoreCase("All"))
            {
                ps=con.prepareStatement("Select admissionnumber,currentform ,currentstream ,firstName,middleName,lastName from admission  ");

            }
            else if(!className.equalsIgnoreCase("All")&& streamName.equalsIgnoreCase("All"))
            {
                ps=con.prepareStatement("Select admissionnumber,currentform,currentstream,firstName,middleName,lastName from admission  where  currentform='"+globals.classCode(className)+"'");

            }
            else  if(className.equalsIgnoreCase("All")&&! streamName.equalsIgnoreCase("All"))
            {
                ps=con.prepareStatement("Select admissionnumber,currentform,currentstream ,firstName,middleName,lastName from admission  where  currentstream='"+globals.streamcode(streamName)+"'");

            }
            else  if(!className.equalsIgnoreCase("All")&&! streamName.equalsIgnoreCase("All"))
            {
                ps=con.prepareStatement("Select admissionnumber,currentform ,currentstream,firstName,middleName,lastName from admission  where  currentstream='"+globals.streamcode(streamName)+"' and  currentform='"+globals.classCode(className)+"'");
...
int counter=0;
            ...
            while(rs.next())
            {
                if(amount.isEmpty())
                {
                    ...
                    Phrase ph4=new Phrase(String.valueOf(paid),new Font(Font.FontFamily.HELVETICA, 7, Font.NORMAL,BaseColor.BLACK));
                    PdfPCell cell4=new PdfPCell(ph4);
                    cell4.setColspan(3);
                    cell4.setVerticalAlignment(Element.ALIGN_BOTTOM);
                    cell4.setHorizontalAlignment(Element.ALIGN_MIDDLE);

                    Phrase ph5=new Phrase(String.valueOf(balance),new Font(Font.FontFamily.HELVETICA, 7, Font.NORMAL,BaseColor.BLACK));
                    PdfPCell cell5=new PdfPCell(ph5);
                    cell5.setColspan(3);
                    cell5.setVerticalAlignment(Element.ALIGN_BOTTOM);
                    cell5.setHorizontalAlignment(Element.ALIGN_MIDDLE);
       ...
       public  void subjectVap(String examcode,String examName,String term,String academicYear,String classname,String stream,String subjectcode )
    {
        ...
        try {
            ...
            PdfPTable tab =new PdfPTable(1);
                 ...
                 tab.setWidthPercentage(100);
                 doc.add(tab);  Paragraph pr5=new Paragraph ("Subject Value Addition Progress Report".toUpperCase(),FontFactory.getFont(FontFactory.HELVETICA,13,java.awt.Font.BOLD,BaseColor.BLACK));
              Chunk glue = new Chunk(new VerticalPositionMark());
            doc.addCreationDate();
             Paragraph pr7=new Paragraph ("CLASS:  "+classname.toUpperCase()+"                 STREAM: "+stream.toUpperCase(),FontFactory.getFont(FontFactory.TIMES,13,java.awt.Font.PLAIN,BaseColor.BLACK));
             pr7.add(new Chunk(glue));
           ...
           doc.add(pr5);
            ...
            public  void FeeStatementGenerator(String adm) {
        Document doc = new Document(); 
         try {
             con=DbConnection.connectDb(schoolDb);
              
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() + "Fee Statement" + ".pdf"));
            doc.open();
...
//                      
           ...
           pr8.setSpacingAfter(10);
            ...
            
            {
                ...
                PdfPCell cell6 = new PdfPCell(ph6);
                cell6.setColspan(4);
                tabb.addCell(cell2); tabb.addCell(cell3); tabb.addCell(cell4); tabb.addCell(cell5); tabb.addCell(cell6);
        ...
        public  void totalFeeStatementGenerator(String adm) {
        Document doc = new Document(); 
         try {
             con=DbConnection.connectDb(schoolDb);
...
//                      
        ...
        public  void paymentVocherGenerator(String vocherNumber,String payeeDetails,String adress,String Date,String invoiceNumber,String description,String amount,String paymentMode,String VoteHeadId,String recipientDetails){
           Document doc=new Document();
           try {
                 ...
                 con=DbConnection.connectDb(schoolDb);
              Image image = Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"" + "PaymentVochure"+vocherNumber + ".pdf"));
            doc.open();
           // doc.add(new Paragraph("Printed On: "+date));
           onEndPage(writer, doc);
            ...
            pra.add(chunk1);pra.add(chunk);pra.add(chunk2);
            doc.add(pra);
    ...
    public  void dayAttendance(String classcode, String streamcode, String termcode, String date, String week) {
        try {
            con = DbConnection.connectDb(schoolDb);

            Document doc = new Document();
            Image image = Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"" + "Day Attendance" + ".pdf"));
            doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
    ...
    public  void indexNumberAssignmentReport(String academicYear)
    {
        try {
                        con = DbConnection.connectDb(schoolDb);
            ...
            Document doc = new Document();
            Image image = Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"" + "Index Numbers Report" + ".pdf"));
            doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
       ...
       public  void generateReport(String title, String docName, JTable table1) {
        try{
            String location;
            ...
            Document doc=new Document();
            Image image= Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer= PdfWriter.getInstance(doc,new FileOutputStream(  docPath.documentFolderPath() +""+docName+".pdf"));
            doc.open();
              onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
    ...
    public  void kcseMissingMarks(String year) {
        try {
            Document doc = new Document(PageSize.A4.rotate());
            Image image = Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"kcsemissingResults" + year + ".pdf"));
            doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
    ...
    public  void kcseMarks(String year, String admissionNumber,boolean analyse) {
        ...
        try {
            Document doc = new Document(PageSize.A4.rotate());
            Image image = Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"kcse" + year + ".pdf"));
            doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
...
//                
     ...
     int count;
      ...
      public  void kcpeMarks(String year, String admissionNumber,boolean analyse) {
        ...
        try {
...

            {
                ...
                while (rs.next()) {
                    ...
                    tabb.addCell(cell4); tabb.addCell(cell4a);
...
cell4.setColspan(2);
    ...
    public  void emptyScoreSheet(String classname, String academicyear, String Stream, String examcode, String examname, String term) {
        try {

            Document doc = new Document();
            Image image = Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"emptyscoresheet.pdf"));
            doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
    ...
    public  void missingResultsOverall(String classname, String academicyear, String Stream, String examcode, String examname, String term) {
        try {

            Document doc = new Document();
            Image image = Image.getInstance(docPath.documentFolderPath()+"logo.jpg");
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"missingmarksoverall.pdf"));
            doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
    ...
    public  void subjectAllocationReport(String classname, String academicyear, String Stream) {
        try {

            Document doc = new Document();
            Image image = Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"subjectallocationReport.pdf"));
            doc.open();
            PdfPTable tab = new PdfPTable(1);
    ...
    public  void subjectResults(String examcode, String examname, String stream, String term, String academicyear, String subjectcode, String classname, String subjectname, String sort) {
        try {
            NumberFormat nf2 = NumberFormat.getInstance();
            nf2.setMaximumFractionDigits(0);
            nf2.setMinimumFractionDigits(0);
            ...
            double meanpoint, meanscore = 0, meanconverted = 0, meanpercent = 0;
            String meangrade = "";
    ...
    public  void missingMarks(String examcode, String examname, String stream, String term, String academicyear, String subjectcode, String classname, String subjectname) {
        try {
            ...
            int counter = 1;
            String sql5 = "Select admissionnumber from studentsubjectallocation,admission where subjectcode='" + subjectcode + "' and academicyear='" + academicyear + "' and admnumber=admissionnumber and currentform='" + globals.classCode(classProgressTracker.currentClass(Integer.parseInt(academicyear), classname))+ "' and currentstream='" + globals.streamcode(stream) + "'";
            ps = con.prepareStatement(sql5);
            rs = ps.executeQuery();
            while (rs.next()) {
                String adm = rs.getString("admissionNumber");
   ...
   public  void kcperesults(String classname)
    {
        try {
            ...
            PdfWriter writer= PdfWriter.getInstance(doc,new FileOutputStream(  docPath.documentFolderPath() +"kcperesults.pdf"));
            doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab =new PdfPTable(1);
                 ...
                 tab.setWidthPercentage(100);
                 doc.add(tab);  Paragraph pr5=new Paragraph ("KCPE RESULTS RANKING",FontFactory.getFont(FontFactory.HELVETICA,13,java.awt.Font.BOLD,BaseColor.BLACK));
              Chunk glue = new Chunk(new VerticalPositionMark());
            doc.addCreationDate();
           ...
           doc.add(pr5);
            ...
            Phrase ph1=new Phrase("ADM Number",new Font(Font.FontFamily.HELVETICA, 7, Font.NORMAL,BaseColor.BLACK));
                    ...
                    PdfPCell cell5=new PdfPCell(ph5);
                     ...
                     cell5.setColspan(5);
              tabb.addCell(cell);  tabb.addCell(cell1);  tabb.addCell(cell2);  tabb.addCell(cell3);tabb.addCell(cell4);tabb.addCell(cell5);
        }
     ...
     public  void MeritListReport(String examname, String examcode, String academicyear, String classname, String term, String stream) {
        double[] means;
        ...
        try {
            ...
            Image image = Image.getInstance(docPath.documentFolderPath()+"logo.jpg");
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"meritList.pdf"));
            ...
            rs = ps.executeQuery();
            if (rs.next()) {
                ranker=rs.getString("AnalysisObject");
...
//            pr8.setSpacingBefore(10);
            ...
            if (stream.equalsIgnoreCase("combined")) {
                ...
                ps = con.prepareStatement(sqlstart,ResultSet.TYPE_SCROLL_SENSITIVE,
                ...
                while (rs.next()) {
                    ...
                    Phrase ph9 = new Phrase(nf.format(rs.getDouble(rankerIndex)), new Font(Font.FontFamily.HELVETICA, 10, Font.NORMAL, BaseColor.RED));
                    PdfPCell cell9 = new PdfPCell(ph9);
                    cell9.setColspan(4);
                    tabb.addCell(cell9);
                    ...
                    tabb.addCell(cell10);
                     ...
                     Phrase ph11 = new Phrase(nf.format(rs.getDouble("vap")), new Font(Font.FontFamily.HELVETICA, 9, Font.NORMAL, BaseColor.BLUE));
                PdfPCell cell11 = new PdfPCell(ph11);
                ...
                double meanpoint = 0, meanscore, meanconverted = 0, meanpercent = 0;
                String meangrade;
                {
    ...
    public  void bookStatistics(String bookSub,String booktype,String bookCodition,String studentClass,String studentSubject)
    {
        try {
             ...
             Document doc = new Document(PageSize.A4.rotate());
            Image image = Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"Book Statistics.pdf"));
            doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
