...
DocHead docHead;
DocPath docPath;
    public GradeDistributionReport(String schoolDb) {
        this.schoolDb = schoolDb;
        globals=new Globals(schoolDb);
        docPath=new DocPath(schoolDb);
        docHead=new DocHead(schoolDb);
    }
    ...
    public  void gradedistributionReport(String examcode, String examname, String term, String classname, String academicyear, String stream,String sort,boolean targets) {
        ...
        try {
            ...
            PdfWriter writer = PdfWriter.getInstance(doc, new FileOutputStream(docPath.documentFolderPath() +"gradeDistributionReport.pdf"));
            doc.open();
                ...
                for(int i=1;i<=2;i++)
{
    ...
    public  void distributionPerSubject(String examcode, String examname, String term, String classname, String academicyear, String stream, String subjectcode,String gender,boolean targets) {
