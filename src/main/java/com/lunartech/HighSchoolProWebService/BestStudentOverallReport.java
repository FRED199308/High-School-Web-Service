...
Globals globals;
DocPath docPath;
    public BestStudentOverallReport(String schoolDb) {
    ...
    public  void beststudents(String examcode,String examname,String term,String academicyear ,String classname,String stream,int number)
    {
        try {
...
nf.setMinimumFractionDigits(2); 
            ...
            PdfWriter writer= PdfWriter.getInstance(doc,new FileOutputStream(  docPath.documentFolderPath() +"BestStudentOverallReport.pdf"));
            doc.open();
         ...
         PdfPTable tab =new PdfPTable(1);
                 ...
                 doc.add(tab);  Paragraph pr5=new Paragraph ("Best Student Overall Report",FontFactory.getFont(FontFactory.HELVETICA,13,java.awt.Font.BOLD,BaseColor.BLACK));
           ...
           doc.add(pr5);
            ...
            Phrase ph4=new Phrase("TOTAL MARKS",new Font(Font.FontFamily.HELVETICA, 7, Font.NORMAL,BaseColor.BLACK));
                    ...
                    cell10.setRotation(90);
                     cell10.setColspan(2);
             tabb.addCell(cell);tabb.addCell(cell1);tabb.addCell(cell2);tabb.addCell(cell3);tabb.addCell(cell4);tabb.addCell(cell5);tabb.addCell(cell6);tabb.addCell(cell6a);
                    tabb.addCell(cell7);tabb.addCell(cell8);tabb.addCell(cell9);tabb.addCell(cell10);
            }
    ...
    public  void mostImprovedArithmetics(String examcode,String examname,String AcademicYear,String classCode,String term,String examcode2,String examname2,String AcademicYear2,String classCode2,String term2)
    {
                 ...
                 while(rs.next())
                 {
                     ...
                     if(globals.gradable(adm, examcode2, AcademicYear2))
                     {
                         ...
                         if(globals.gradable(adm, examcode, AcademicYear))
                         {
                             ...
                             while(RS.next())
                             {
                                 int score=0,score2=0,divscore,divmean=0;
                             ...
                             double mean=0.0,mean2=0.0,divmean;
...
//                 }
    ...
    public  void improvedStudentsReport(String examcode,String examname,String AcademicYear,String classCode,String term,String examcode2,String examname2,String AcademicYear2,String classCode2,String term2,String stream,String classname,int limit)
    {
        try {
...
nf.setMinimumFractionDigits(2); 
            ...
            Document doc=new Document();
            Image image= Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer= PdfWriter.getInstance(doc,new FileOutputStream(  docPath.documentFolderPath() +"MostImprovedOverallReport.pdf"));
         doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
...
cell6.setRotation(90);
            ...
            while(rs.next())
            {
                ...
                System.out.println( "The System Has Not Detected Any Improvement Report On The Selected Exams\n Kindly Select Analyse First In Order To Generate The Report For The Selected Exams");
            }
     ...
     public  void improvedStudentsReportPerSubject(String examcode,String examname,String AcademicYear,String classCode,String term,String examcode2,String examname2,String AcademicYear2,String classCode2,String term2,String classname,String stream,String subjectName,int limit)
    {
...
nf.setMinimumFractionDigits(2); 
            ...
            Document doc=new Document();
            Image image= Image.getInstance(docPath.documentFolderPath() +"logo.jpg");
            PdfWriter writer= PdfWriter.getInstance(doc,new FileOutputStream(  docPath.documentFolderPath() +"MostImprovedPerSubjectReport.pdf"));
         doc.open();
            onEndPage(writer, doc);
            doc.add(new Paragraph(new Date().toString()));
            PdfPTable tab = new PdfPTable(1);
