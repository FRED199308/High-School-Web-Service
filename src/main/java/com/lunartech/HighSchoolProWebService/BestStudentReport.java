...
Globals globals;
DocPath docPath;
    public BestStudentReport(String schoolDb) {
    ...
    public  void subjectResults(String examcode,String examname,String term,String academicyear ,String classname,String subjectname,String number)
    {
        try {
            String subjectcode;
            ...
            PdfWriter writer= PdfWriter.getInstance(doc,new FileOutputStream(  docPath.documentFolderPath() +"BestStudentperSubject.pdf"));
            doc.open();
    ...
    DocHead head=new DocHead(schoolDb);
               ...
               con=DbConnection.connectDb(schoolDb);
                 ...
                 doc.add(tab);  Paragraph pr5=new Paragraph ("Best STudent per subject report".toUpperCase(),FontFactory.getFont(FontFactory.HELVETICA,13,java.awt.Font.BOLD,BaseColor.BLACK));
           ...
           doc.add(pr5);
            ...
            Phrase ph4=new Phrase("RAW MARKS X/",new Font(Font.FontFamily.HELVETICA, 7, Font.NORMAL,BaseColor.BLACK));
               ...
               while(rx.next())
               {
                   ...
                   int headcount=0;int previousscore=0;int totalentries=0;
           ...
           previousscore=rs.getInt("Examscore");
            ...
            Phrase ph4=new Phrase(rs.getString("examScore"),new Font(Font.FontFamily.HELVETICA, 7, Font.NORMAL,BaseColor.BLACK));
                    ...
                    PdfPCell cell10=new PdfPCell(ph10); 
                     ...
                     cell10.setColspan(2);
                    tabb.addCell(cell);tabb.addCell(cell1);tabb.addCell(cell2);tabb.addCell(cell3);tabb.addCell(cell4);tabb.addCell(cell5);tabb.addCell(cell6);tabb.addCell(cell6a);
                    tabb.addCell(cell7);tabb.addCell(cell8);tabb.addCell(cell9);tabb.addCell(cell10); counter++;
